 ...
 *  @generated
 */
package com.laravelshao.learning.thrift.generated;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2019-10-26")
public class PersonService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person recv_getPersonByUsername() throws DataException, org.apache.thrift.TException
    {
      ...
      if (result.dataExpection != null) {
        throw result.dataExpection;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getPersonByUsername<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUsername_args> {
      ...
      public getPersonByUsername_result getResult(I iface, getPersonByUsername_args args) throws org.apache.thrift.TException {
        ...
        } catch (DataException dataExpection) {
          result.dataExpection = dataExpection;
        }
        return result;
      }
    }
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Person>() { 
          ...
          public void onError(Exception e) {
            ...
            if (e instanceof DataException) {
              result.dataExpection = (DataException) e;
              result.setDataExpectionIsSet(true);
              msg = result;
  ...
  public static class getPersonByUsername_result implements org.apache.thrift.TBase<getPersonByUsername_result, getPersonByUsername_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUsername_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXPECTION_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExpection", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable DataException dataExpection; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SUCCESS((short)0, "success"),
      DATA_EXPECTION((short)1, "dataExpection");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 0: // SUCCESS
            return SUCCESS;
          case 1: // DATA_EXPECTION
            return DATA_EXPECTION;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_EXPECTION, new org.apache.thrift.meta_data.FieldMetaData("dataExpection", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public getPersonByUsername_result(
      Person success,
      DataException dataExpection)
    {
      this();
      this.success = success;
      this.dataExpection = dataExpection;
    }
    ...
    public getPersonByUsername_result(getPersonByUsername_result other) {
      ...
      if (other.isSetDataExpection()) {
        this.dataExpection = new DataException(other.dataExpection);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public DataException getDataExpection() {
      return this.dataExpection;
    }

    public getPersonByUsername_result setDataExpection(@org.apache.thrift.annotation.Nullable DataException dataExpection) {
      this.dataExpection = dataExpection;
      return this;
    }

    public void unsetDataExpection() {
      this.dataExpection = null;
    }

    /** Returns true if field dataExpection is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExpection() {
      return this.dataExpection != null;
    }

    public void setDataExpectionIsSet(boolean value) {
      if (!value) {
        this.dataExpection = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case DATA_EXPECTION:
        if (value == null) {
          ...
          setDataExpection((DataException)value);
        }
        break;
    ...
    public boolean equals(getPersonByUsername_result that) {
      ...
      boolean this_present_dataExpection = true && this.isSetDataExpection();
      boolean that_present_dataExpection = true && that.isSetDataExpection();
      if (this_present_dataExpection || that_present_dataExpection) {
        if (!(this_present_dataExpection && that_present_dataExpection))
          return false;
        if (!this.dataExpection.equals(that.dataExpection))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataExpection()) ? 131071 : 524287);
      if (isSetDataExpection())
        hashCode = hashCode * 8191 + dataExpection.hashCode();
    ...
    public int compareTo(getPersonByUsername_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetDataExpection()).compareTo(other.isSetDataExpection());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExpection()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExpection, other.dataExpection);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("dataExpection:");
      if (this.dataExpection == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExpection);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getPersonByUsername_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPersonByUsername_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // DATA_EXPECTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExpection = new DataException();
                struct.dataExpection.read(iprot);
                struct.setDataExpectionIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.dataExpection != null) {
          oprot.writeFieldBegin(DATA_EXPECTION_FIELD_DESC);
          struct.dataExpection.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    public savePerson_result setDataExpection(@org.apache.thrift.annotation.Nullable DataException dataExpection) {
      this.dataExpection = dataExpection;
      return this;
    }
